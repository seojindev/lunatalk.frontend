...
export default function Main2Publish() {
    return (
        <>
                                            ...
                                            <ul className="mega-menu mega-menu-padding">
                                                <li>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="index-11.html">Home 11 - showcase slider</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="index-33.html">Home 33 – Medical Equipment</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                            ...
                                            <ul className="mega-menu">
                                                <li>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="shop-list-fw-2col.html">list 2 column full wide</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
            ...
            <div className="slider-area ml-70 mr-70">
                <div className="slider-active owl-carousel nav-style-1 owl-dot-none">
                            ...
                            <div className="row">
                                <div className="col-xl-6 col-lg-6 col-md-7 ml-auto">
                                    <div className="slider-content-2 slider-animated-1">
                                        <h3 className="animated">Sale Off 40%</h3>
                    ...
                    <div
                        className="single-slider-2 slider-height-1 d-flex align-items-center slider-height-res bg-img"
                        style={{ backgroundImage: `url(/assets/img/slider/slider-2-2.jpg)` }}
                    >
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-6 col-lg-6 col-md-7 ml-auto">
            ...
            <div className="banner-area pt-60 pb-65">
                <div className="container">
                    <div className="row">
                                    ...
                                    <div className="product-wrap-2 mb-25">
                                        ...
                                        <div className="product-content-2">
                                            <div className="title-price-wrap-2">
                                                <h3>
                                                    <a href="product-details.html">Awesome Tote Bag</a>
                                                </h3>
                                ...
                                <div className="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                                    <div className="product-wrap-2 mb-25">
                                        ...
                                        <div className="product-content-2">
                                            <div className="title-price-wrap-2">
                                                <h3>
                                                    <a href="product-details.html">Leather Crossbody Purse</a>
                                                </h3>
                                                <div className="price-2">
                                                    <span>$ 40.00</span>
                                ...
                                <div className="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                                    <div className="product-wrap-2 mb-25">
                                        ...
                                        <div className="product-content-2">
                                            <div className="title-price-wrap-2">
                                                <h3>
                                                    <a href="product-details.html">Sunflower Shoes</a>
                                                </h3>
                                                <div className="price-2">
                                                    <span>$ 80.00</span>
                                                </div>
                                ...
                                <div className="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                                    <div className="product-wrap-2 mb-25">
                                        ...
                                        <div className="product-content-2">
                                            <div className="title-price-wrap-2">
                                                <h3>
                                                    <a href="product-details.html">Makeup Brushes</a>
                                                </h3>
                                                <div className="price-2">
                                                    <span>$ 20.00</span>
                                ...
                                <div className="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                                    <div className="product-wrap-2 mb-25">
                                        ...
                                        <div className="product-content-2">
                                            <div className="title-price-wrap-2">
                                                <h3>
                                                    <a href="product-details.html">Ladies Gown</a>
                                                </h3>
                                                <div className="price-2">
                                                    <span>$ 50.00</span>
                                                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-2 col-md-4 col-sm-4">
                            <div className="copyright mb-30">
                                ...
                                <p>
                                    © 2021 <a href="#">Shopieal</a>.<br /> All Rights Reserved
                                </p>
                            </div>
                        </div>
                        <div className="col-lg-2 col-md-4 col-sm-4">
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-6">
                            <div className="footer-widget mb-30 ml-75">
                                ...
                                <div className="footer-list">
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/shopieal.com.bd">Facebook</a>
                                        </li>
                                        <li>
                                            <a href="https://www.twitter.com/info_shopieal">Twitter</a>
                                        </li>
                                        <li>
                                            <a href="https://www.instagram.com/shopieal.com.bd">Instagram</a>
                                        </li>
                                        <li>
                                            <a href="https://www.youtube.com/channel/UCngp67Rgjn1EM_78v3oX9Qw">
                                                Youtube
                                            </a>
                                        </li>
                                    </ul>
